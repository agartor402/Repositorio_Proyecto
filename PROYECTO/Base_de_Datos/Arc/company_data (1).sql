...
1. Auto-incremento en MariaDB vs. Oracle

En MariaDB, las claves primarias con AUTO_INCREMENT se generan automáticamente.

En Oracle, se usa GENERATED ALWAYS AS IDENTITY, que ya está presente en tu script y es la forma correcta.

2. Tipos de datos compatibles

VARCHAR2 es correcto en Oracle. En MariaDB usarías VARCHAR.

NUMBER(8,2), NUMBER(9,2), etc., son correctos para representar valores numéricos con decimales.

3. ON DELETE CASCADE y ON DELETE SET NULL

Estas restricciones están bien definidas en tu script y funcionarán igual en Oracle.

4. Claves foráneas y constraints

Todas están bien estructuradas y deberían funcionar sin problema.
...
Insert into CUSTOMERS (CUSTOMER_ID,NAME,ADDRESS,CREDIT_LIMIT,WEBSITE) values (55,'Goodyear Tire and Rubber','600 N Broadway Fl 1, Milwaukee, WI',700,'http://www.goodyear.com');
